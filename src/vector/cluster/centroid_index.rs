...
///   - ~4x smaller; for the cohere-1M index the cluster file shrinks from
///     ~5MB/segment to ~1.3MB/segment, directly reducing per-query read_bytes.
...
impl CentroidIndex {
    ...
    pub fn load_from_bytes(
        ...
        let data: Vec<i8> = unsafe {
            std::slice::from_raw_parts(data_bytes.as_ptr() as *const i8, total).to_vec()
        };
