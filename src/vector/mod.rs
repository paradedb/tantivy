...
pub use backend::{
    DEFAULT_FIXED_PROBE_COST_ROWS, ProbeStats, ProbeTermination, VectorBackend,
    set_fixed_probe_cost_rows,
};
pub use bounds::{
    BoundKind, BoundStore, BoundsBuilder, HeapPeek, QueryBound, Verdict, bounds_verdict,
    margin_ball_ball, margin_ball_halfspace, residual_norm, to_bound_space,
};
...
pub use ivf::{
    ...
    SearchTerminationReason, SliceStore, StackedIvfIndex, StackedSearchStats,
