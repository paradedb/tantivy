...
pub struct SegmentWriter {
    ...
    /// order during `finalize`; looked up by concrete type via
    /// [`SegmentWriter::plugin_writer_mut`].
...
impl SegmentWriter {
    ...
    pub fn finalize(mut self) -> crate::Result<Vec<u64>> {
        ...
        remap_and_write(&self.segment, self.plugin_writers)?;
