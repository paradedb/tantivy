...
/// The built-in [`SegmentPlugin`] that manages fast fields.
...
/// The [`PluginWriter`] for the fast fields plugin.
...
impl FastFieldsPluginWriter {
    /// Returns a mutable reference to the inner fast fields writer.
    ...
    /// Returns a reference to the inner fast fields writer.
