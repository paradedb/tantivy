...
mod tests {
    ...
    use crate::query::{
        Bm25Weight, EnableScoring, Scorer, TermQuery, DEFAULT_BM25_B, DEFAULT_BM25_K1,
    };
    ...
    fn test_term_scorer_max_score() -> crate::Result<()> {
        let bm25_weight = Bm25Weight::for_one_term(3, 6, 10.0, DEFAULT_BM25_K1, DEFAULT_BM25_B);
    ...
    fn test_term_scorer_shallow_advance() -> crate::Result<()> {
        let bm25_weight =
            Bm25Weight::for_one_term(300, 1024, 10.0, DEFAULT_BM25_K1, DEFAULT_BM25_B);
    ...
    fn test_block_wand() {
        ...
        let bm25_weight = Bm25Weight::for_one_term(10, 129, 20.0, DEFAULT_BM25_K1, DEFAULT_BM25_B);
