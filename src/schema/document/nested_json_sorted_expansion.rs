...
//     println!("parse_json_for_nested_sorted: Starting parsing of JSON for nested sorted
// documents");
...
//         println!(
//             "parse_value: No recognized nested_field => fallback storage (text only).
...
//             )?;
//         }
//         // If the schema returned a "nested" style field that is not actually Nested or
// NestedJson,         // skip further expansions
//         _ => {
//             println!(
...
// ) -> Result<(), DocParsingError> {
//     println!(
//         "expand_nested_value: Expanding field {:?} with include_in_parent={},
// store_parent_flag={}, gather_tokens={}, depth={}",         nested_field, include_in_parent,
// store_parent_flag, gather_tokens, depth     );
...
//         println!(
//             "expand_nested_value: Value is a scalar => include_in_parent={}, gather_tokens={},
// depth={}",             include_in_parent, gather_tokens, depth
//         );
...
//         // It's a scalar
//         println!(
//             "expand_single_nested_item: scalar => include_in_parent={}, gather_tokens={},
// depth={}",             include_in_parent, gather_tokens, depth
//         );
//         if include_in_parent {
//             store_scalar_in_doc(parent_doc, nested_field, val);
...
// fn store_object_in_doc(doc: &mut TantivyDocument, field: Field, obj: &JsonMap<String,
// SerdeValue>) {     println!(
