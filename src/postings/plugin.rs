...
use crate::{DocId, InvertedIndexReader};

/// The built-in [`SegmentPlugin`] that manages the inverted index (postings, positions, term
/// dictionary).
...
/// The [`PluginWriter`] for the postings plugin.
