...
modes={'original_raw':('old',False,False),'original_packed':('old',True,False),'rewritten_raw':('new',False,False),'rewritten_packed':('new',True,False),'embedded':('new',True,True)}
